...
from omni.isaac.lab_tasks.manager_based.manipulation.lift.lift_env_cfg_camera import LiftEnvCfg
...
@configclass
class FrankaCubeLiftEnvCameraCfg(LiftEnvCfg):
    def __post_init__(self):
        ...
        # from here to get the camera info
        self.scene.camera = CameraCfg(
            prim_path="{ENV_REGEX_NS}/Robot/stardust_pro/down_camera_link/camera_01_color_optical_frame",
            update_period=0.1,
            height=480,
            width=640,
